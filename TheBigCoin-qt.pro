...
fName1 = "TheBigCoin-Qt"
macx:TARGET = "TheBigCoin-Qt"
VERSION = 1.0.7
QMAKE_TARGET_BUNDLE_PREFIX = co.TheBigCoin
...
BDB_INCLUDE_PATH=C:/deps/db-4.8.30/build_unix
BDB_LIB_PATH=C:/deps/db-4.8.30/build_unix
...
macx: {
    ...
    ICON = src/qt/res/icons/TheBigCoin.icns
    TARGET = Bets-v1.0.0.7-qt
