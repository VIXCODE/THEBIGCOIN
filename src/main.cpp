...
int nCoinbaseMaturity = 15; // confirm
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            if(nBestHeight == 0)                      {      nSubsidy = 1000000000 * COIN; }//premine for pre-sale, bounty, airdrop, exchange listing and others
			else if(nBestHeight <= 11)	            {     nSubsidy = 1000000000 * COIN;   }
            else if(nBestHeight <= 350)            {     nSubsidy = 100 * COIN;   }
			else if(nBestHeight <= 100000)       {     nSubsidy = 80 * COIN;     }
...
{	
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
	  ...
	  if(nBestHeight <= 290)                    {   nSubsidy = nSubsidy *   0;   }
	  else if(nBestHeight <= 100000)        {   nSubsidy = nSubsidy * 40;   }
	  else if(nBestHeight <= 200000)        {   nSubsidy = nSubsidy * 45;   }
	  else if(nBestHeight <= 300000)        {   nSubsidy = nSubsidy * 50;   }
	  else if(nBestHeight <= 1000000)      {   nSubsidy = nSubsidy * 60;   }
	  else if(nBestHeight <= 5000000)      {   nSubsidy = nSubsidy * 70;   }
	  else if(nBestHeight <= 50000000)    {   nSubsidy = nSubsidy * 70;   }
	  else if(nBestHeight <= 150000000)  {   nSubsidy = nSubsidy * 84;   }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TheBigCoin - 01 jun 2022";
        CTransaction txNew;
        txNew.nTime = 1654612836;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1654612836;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 4855602 : 4855602;
...
//block.GetHash() == 000002dd6c8dcef49d10625ee71e53914f2a5703924403322bd1902ca4539f26
//block.hashMerkleRoot == 50257402ae8234ba057d2c9e238ad663c160a5c87f7596241d8dd45d2e63b117
//block.nTime = 1654612836
//block.nNonce = 4855602
        ...
        assert(block.hashMerkleRoot == uint256("0x50257402ae8234ba057d2c9e238ad663c160a5c87f7596241d8dd45d2e63b117"));
